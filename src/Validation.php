...
use Neko\Validation\Rules\Required;
...
class Validation
{
     ...
     * Constructor
     *
     * @param Neko\Validation\Validator $validator
     * @param array $inputs
     * @param array $rules
     ...
     *
     * @param string $attributeKey
     * @return null|Neko\Validation\Attribute
     */
     ...
     *
     * @return Neko\Validation\ErrorBag
     */
     ...
     * @param Neko\Validation\Attribute $attribute
     * @param mixed $value
     * @param Neko\Validation\Rule $ruleValidator
     * @return void
     */
     ...
     * @param Neko\Validation\Attribute $attribute
     * @param mixed $value
     * @param Neko\Validation\Rule $validator
     * @return mixed
     */
     ...
     *
     * @return Neko\Validation\Validator
     */
