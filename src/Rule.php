...
use Neko\Validation\MissingRequiredParameterException;
...
abstract class Rule
{
    ...
    /** @var Neko\Validation\Attribute|null */
    protected $attribute;

    /** @var Neko\Validation\Validation|null */
     ...
     *
     * @param Neko\Validation\Validation $validation
     * @return void
     */
     ...
     * Set attribute
     *
     * @param Neko\Validation\Attribute $attribute
     * @return void
     */
     ...
     * Get attribute
     *
     * @return Neko\Validation\Attribute|null
     */
     ...
     * @param array $params
     * @return void
     * @throws Neko\Validation\MissingRequiredParameterException
     */
